...
export const leaderboardData: LeaderboardEntry[] = [
  { rank: 1, name: "绿茵预言家", avatar: "🔮", score: 2460, correctRate: 78, badges: ["👑 冠军", "🔥 10连胜", "🎯 精准预测"] },
  { rank: 2, name: "足球先知", avatar: "📊", score: 2210, correctRate: 75, badges: ["🥈 亚军", "🔥 5连胜"] },
  { rank: 3, name: "梅老板的右脚", avatar: "⚡", score: 1980, correctRate: 72, badges: ["🥉 季军", "🎯 精准预测"] },
  ...
  { rank: 6, name: "阿根廷别哭泣", avatar: "🇦🇷", score: 1680, correctRate: 69, badges: ["🎯 精准预测"] },
  { rank: 7, name: "英超通", avatar: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", score: 1590, correctRate: 67, badges: [] },
  { rank: 8, name: "足球小将南葛", avatar: "⚽", score: 1510, correctRate: 66, badges: ["🔥 3连胜"] },
...
export const weeklyLeaderboard: LeaderboardEntry[] = leaderboardData.map(e => ({
  ...e,
  score: Math.floor(e.score * (0.3 + Math.random() * 0.4)),
}))
